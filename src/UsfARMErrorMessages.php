...
trait UsfARMErrorMessages {
    ...
    static $ARM_ERROR_MESSAGES = array(
        ...
        'ACCOUNT_REVIEW_UNSET_BY_MANAGER' => 'Account does not have a review set by current supervisor!',
        'ACCOUNT_REVIEW_DELEGATED_TO_SELF' => 'A review cannot be delegated to the owner of the account',
        'ACCOUNT_STATE_UNSET_BY_MANAGER' => 'Account does not have a state set by current supervisor!',
        'ACCOUNT_ROLE_STATE_UNSET_BY_MANAGER' => 'Account role does not have a state set by current supervisor!',
